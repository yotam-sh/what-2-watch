...
// Minimal signup form. Deliberately plain — see the plan: "unstyled-but-clean",
// mobile-first because this becomes a PWA in Phase 4. All it does is POST to
// /api/auth/signup and let the httpOnly cookie the server sets handle the
// rest of the session.
    ...
    <main className="flex min-h-screen flex-col items-center justify-center px-6 py-12">
      <div className="w-full max-w-sm">
        ...
        <p className="text-sm text-zinc-500 text-center mb-6">
          Your Plex token — once linked — is encrypted with a key derived from
          this password. If you forget it, that link is unrecoverable by design.
        </p>
